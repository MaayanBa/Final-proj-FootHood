...
import Modal_JoinRequests from './Modal_JoinRequests';
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={{ paddingTop: 30 }}>
            <Animatable.Text animation="pulse" easing="ease-out" iterationCount="infinite" style={appCss.inputLabel}>Last Registration Date: 5/11/2021</Animatable.Text>
